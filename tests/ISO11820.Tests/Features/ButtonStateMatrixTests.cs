...
public sealed class ButtonStateMatrixTests
{
    ...
    public void Preparing_Only_Allows_StopHeating()
    {
        ...
        Assert.False(states["TestRecord"]);
    }
    ...
    {
        string[] expectedKeys = { "NewTest", "StartHeating", "StopHeating", "StartRecording", "StopRecording", "ParameterSettings", "TestRecord" };
